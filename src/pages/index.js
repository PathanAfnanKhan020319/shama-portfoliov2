...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Pathan Afnan Khan | AI Engineer • Data Scientist • Agentic AI • Generative AI
        </title>

        <meta
          name="description"
          content="Portfolio of Pathan Afnan Khan, an AI Engineer and Data Scientist specializing in Agentic AI, Generative AI, LLMs, RAG, Machine Learning, and production-grade AI systems."
        />

        <meta
          name="keywords"
          content="Pathan Afnan Khan, AI Engineer, Data Scientist, Agentic AI Engineer, Generative AI Engineer, LLM Engineer, Machine Learning Engineer, RAG, LangGraph, LangChain, MLOps, GCP, Azure"
        />

        <meta
          name="author"
          content="Pathan Afnan Khan"
        />
        ...
        <meta
          property="og:title"
          content="Pathan Afnan Khan | AI Engineer & Data Scientist"
        />
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src={profilePic}
                  alt="Pathan Afnan Khan - AI Engineer and Data Scientist"
                  priority
                  onLoad={() =>
                    setLoaded(true)
                  }

...
const About = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Pathan Afnan Khan | AI Engineer • Data Scientist • About
        </title>

        <meta
          name="description"
          content="About Pathan Afnan Khan, an AI Engineer and Data Scientist specializing in Agentic AI, Generative AI, LLMs, RAG, Machine Learning and production AI systems."
        />

        <meta
          name="keywords"
          content="Pathan Afnan Khan, AI Engineer, Data Scientist, Agentic AI, Generative AI, LLM, RAG, Machine Learning, MLOps, Cloud AI"
        />
      </Head>
